                                ...
                                <div style={{ background: 'var(--bg-color)', padding: '1.5rem', borderRadius: 'var(--radius-md)', textAlign: 'left', marginBottom: '2rem', border: '1px solid var(--border)' }}>
                                    <label style={{ display: 'flex', gap: '0.75rem', alignItems: 'flex-start', cursor: 'pointer' }}>
                                        ...
                                        <span style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
                                            <b>Autorización para el tratamiento de datos personales y confirmación de veracidad:</b><br/>
                                            Declaro bajo gravedad de juramento que la información aquí suministrada es veraz y verificable. Autorizo expresamente a la empresa para recolectar, tratar mis datos personales y realizar validaciones en centrales de riesgo, bases de datos restrictivas, listas vinculantes (Procuraduría, Policía, OFAC, ONU, etc.) conforme a las políticas del manual SAGRILAFT corporativo.
                                        </span>
                                    </label>
                                </div>
